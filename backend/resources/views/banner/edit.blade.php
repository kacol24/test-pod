...
@section('content')
    <main class="pb-3 pb-md-5" role="main" style="">
        <form class="form-validate" action="{{route($entitySingular . '.update', $entity->id)}}" method="post"
                        ...
                        <div class="row no-gutters justify-content-between mb-3">
                            <div class="col-md-auto d-flex align-items-center">
                                <h1 class="page-title m-0">
                                    {{Lang::get($entitySingular . '.editbanner')}}
                                </h1>
                            </div>
                            <div class="col-md-auto d-flex align-items-center">
                            ...
                            <div class="card-body">
                                <div class="form-group">
                                    @if($entity->desktop_image)
                                        <div class="mb-3">
                                            <img
                                                src="{{image_url('desktop',$entity->desktop_image)}}"
                                                class="img-fluid" alt="desktop banner"/>
                                        </div>
                                    @endif
                            ...
                            <div class="card-body">
                                <div class="form-group">
                                    @if($entity->mobile_image)
                                        <div class="mb-3">
                                            <img
                                                src="{{image_url('mobile',$entity->mobile_image)}}"
                                                class="img-fluid" alt="mobile banner"/>
                                        </div>
                                    @endif
                                    <div class="custom-file">
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" name="order_weight">
                                                @for($i=1;$i<=20;$i++)
                                                <option @if($entity->order_weight==$i) selected @endif>{{$i}}</option>
                                                @endfor
                                            </select>
                                        </div>
                                    </div>
                        ...
                        <div class="sticky-top" style="top: 85px;">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="url" id="url"
                                       placeholder="ex: http://google.com" value="{{$entity->url}}">
                            </div>
                            <hr>
                            <div class="form-group">
                                ...
                                <select name="is_active" class="form-control" id="is_active">
                                    <option @if($entity->is_active==1) selected="selected" @endif value="1">
                                        {{ __('general.yes') }}
                                    </option>
                                    <option @if($entity->is_active==0) selected="selected" @endif value="0">
                                        {{ __('general.no') }}
                                    </option>
                                </select>
                            </div>
