  ...
  <div class="container container--app" id="overview">
    ...
    <div class="row justify-content-between">
        <div class="col-5 col-md-auto d-none d-md-flex align-items-center">
            <h1 class="page-title m-0">Business </h1>
        </div>
      ...
      <div class="card mt-3 p-0">
          <div class="card-header border-bottom-0">
              <div class="row align-items-center">
                  ...
                  <div class="col-auto">
                      <a href="{{ route('business.statistics') }}" class="btn btn-default rounded-pill btn-sm px-3" data-confirm="Send statistic email to all business owners?">
          ...
          <table id="datatable"
                 ...
                 data-url="{{ route('business.datatable') }}">
              <thead>
              <tr>
