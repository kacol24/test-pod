...
<head>
    ...
    <title>Login Admin | Goodcommerce</title>
</head>
<body class="h-100">

<main role="main" class="h-100 d-flex align-items-center justify-content-center"
      style="background:url({{asset('images/img_gradient.png')}}) no-repeat center">
    <div class="container">
                ...
                <form method="post" action="{{route('login.post')}}">
                    ...
                    <div class="card p-0 mx-auto" style="max-width: 380px">
                        <div class="card-header border-0 p-0 position-relative">
                            <img src="{{asset('images/img_login_banner.jpg')}}" alt=""
                                 class="w-100 img-fluid">
                            <div
                                class="position-absolute w-100 h-100 d-flex flex-column align-items-start justify-content-end p-4"
                                style="top: 0;left: 0;">
                                <img src="{{asset('images/logo-white.png')}}" alt="goodcommerce logo"
                                     class="img-fluid">
                        ...
                        <div class="card-body p-md-4">
                            ...
                            <fieldset>
                                ...
                                <div class="form-group position-relative">
                                    ...
                                    <a href="{{ route('forget') }}" class="position-absolute"
                                       style="top: 0;right: 0;">
                                        <small>
                                            Forgot Password?
                                        </small>
