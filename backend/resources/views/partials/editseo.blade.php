<div class="card card--widget p-0">
  ...
  <div class="card-body">
      <div class="form-group">
          ...
          <input type="text" class="form-control" name="meta_title" id="meta_title" placeholder="Page Title" value="{{$entity->meta('en')->meta_title}}">
      </div>
      <div class="form-group">
          <label class="text-uppercase"for="meta_keyword">Meta Keyword (Separated By ,)</label>
          <input type="text" class="form-control" name="meta_keyword" id="meta_keyword" placeholder="Meta Keyword" value="{{$entity->meta('en')->meta_keyword}}">
      </div>
      <div class="form-group">
          <label class="text-uppercase" for="meta_description">Meta Description</label>
          <textarea class="form-control" name="meta_description" id="meta_description" rows="6" placeholder="Meta Descriptions">{{$entity->meta('en')->meta_description}}</textarea>
      </div>
  </div>
</div>