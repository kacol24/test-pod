...
<main class="pb-3 pb-md-5" role="main" style="">
  ...
  @endforeach
  <form class="form-validate" action="{{route('admin.store')}}" method="post" enctype="multipart/form-data">
    {{ csrf_field() }}
                    ...
                    <div class="card-body">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="name" id="name"
                                           placeholder="{{Lang::get('admin.name')}}" value="{{old('name')}}"
                                           required="true">
                        </div>
                        <div class="form-group">
                            <label class="text-uppercase" for="">
                        ...
                        <div class="form-group">
                            ...
                            <select name="role" class="form-control" required="true">
                                ...
                                @foreach($roles as $role)
                                    <option @if(old('role')==$role->id) selected="selected"
