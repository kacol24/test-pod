  ...
  <div class="container container--app" id="overview">
    ...
    <div class="row justify-content-between">
        <div class="col-5 col-md-auto d-none d-md-flex align-items-center">
            <h1 class="page-title m-0">{{Lang::get('admin.roles')}} </h1>
        </div>
        <div class="col col-md-auto">
            <div class="row no-gutters">
                <div class="col-md-auto order-md-10 mb-3 mb-md-0">
                  <div class="d-flex justify-content-end">
                    <a class="btn btn-primary" href="{{route('role.add')}}">
                ...
                <div class="col-md order-md-5 d-flex align-items-center">
                    <div class="form-group mb-0 w-100">
                        <div class="input-group ">
                            <input class="form-control search-query" name="search" placeholder="{{Lang::get('admin.searchbyrole')}}" type="text" value="">
  ...
  <div class="container container--app">
      <div class="card mt-3 p-0">
          <table id="datatable"
                 ...
                 data-url="{{ route('role.datatable') }}">
              <thead>
              <tr>
                  <th data-field="name">{{Lang::get('admin.rolename')}}</th>
