...
@section('content')
    <div class="container">
        <div class="text-center mx-auto" style="max-width: 550px">
            ...
            <div class="border rounded p-3 border-color:black text-start">
                    ...
                    <dd>
                        <strong>
                            ...
                            <a href="javascript:void(0)"
                               class="text-decoration-none fw-400" @include('partials.data-copy', ['copyText' => '1158816018308608'])>Copy</a>
                        </strong>
                    </dd>
                </dl>
                <dl class="d-flex justify-content-between font-size:12">
                    ...
                    <dd>
                        <strong>
                            IDR 280,000
                            <a href="javascript:void(0)"
                               class="text-decoration-none fw-400" @include('partials.data-copy', ['copyText' => '280000'])>Copy</a>
                        </strong>
                    </dd>
                </dl>
                <div class="alert alert-primary d-flex" role="alert">
                    ...
                    <div class="font-size:12 ms-2">
                        Please make payment before: Thursday, 30 December 2021 15:43
            ...
            <hr>
            <button class="btn btn-primary ms-auto px-5">
                Proceed
            </button>
        </div>
    </div>
